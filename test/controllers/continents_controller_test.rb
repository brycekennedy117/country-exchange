...
class ContinentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create continent" do
    assert_difference('Continent.count') do
      post continents_url, params: { continent: { description: @continent.description, name: @continent.name } }
    end
  ...
  test "should update continent" do
    patch continent_url(@continent), params: { continent: { description: @continent.description, name: @continent.name } }
